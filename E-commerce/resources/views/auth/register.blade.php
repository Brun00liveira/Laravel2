...
<div class="limiter">
    <div class="container-login100" style="background-image: url('{{ asset('image/bg-01.jpg') }}');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form class="login100-form validate-form" method="POST" action="{{ route('register.show') }}">sssssss
                @csrf
                ...
                <div class="wrap-input100 validate-input m-b-10" data-validate="Email is required">
                    ...
                    <input class="input100" type="email" name="email" placeholder="Type your email" value="{{ old('Type your email') }}">
                    @if ($errors->has('email'))
                ...
                <div class="wrap-input100 validate-input m-b-10" data-validate="Password is required">
                    ...
                    <input class="input100" type="text" name="password_confirmation" placeholder="confirm your password">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
